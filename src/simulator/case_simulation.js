...
const skins = [
  ...
  new Skin('Glock-18', 'Umbral Rabbit', 0.62, 19605, 20763, 1.159),
  ...
  new Skin('Glock-18', 'Umbral Rabbit', 0.94, 14609, 15562, 0.954),
  ...
  new Skin('Glock-18', 'Umbral Rabbit', 1.44, 11224, 12003, 0.78),
  ...
  new Skin('Glock-18', 'Umbral Rabbit', 2.26, 7702, 8333, 0.632),
