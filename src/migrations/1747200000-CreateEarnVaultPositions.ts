...
export class CreateEarnVaultPositions1747200000 implements MigrationInterface {
  name = 'CreateEarnVaultPositions1747200000'
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      DROP INDEX IF EXISTS "IDX_earn_vault_positions_active_ends";
    `)

    await queryRunner.query(`
      DROP INDEX IF EXISTS "IDX_earn_vault_positions_user_status";
    `)
