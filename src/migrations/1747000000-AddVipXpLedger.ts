...
export class AddVipXpLedger1747000000 implements MigrationInterface {
  name = 'AddVipXpLedger1747000000'
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      DROP INDEX IF EXISTS "IDX_vip_ledger_user_created";
    `)

    await queryRunner.query(`
      DROP TABLE IF EXISTS "vip_ledger";
    `)

    await queryRunner.query(`
      ALTER TABLE "users"
      DROP COLUMN IF EXISTS "vip_theoretical_rake",
      DROP COLUMN IF EXISTS "vip_xp";
    `)
  }
}
