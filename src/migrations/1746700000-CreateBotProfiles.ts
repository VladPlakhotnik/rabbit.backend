...
export class CreateBotProfiles1746700000 implements MigrationInterface {
  name = 'CreateBotProfiles1746700000'
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('DROP TABLE IF EXISTS "bot_profiles";')
  }
}
